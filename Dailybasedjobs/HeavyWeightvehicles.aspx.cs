...
{
    public partial class HeavyWeightvehicles : System.Web.UI.Page
    {
        ...
        private void Bind()
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select * from PostJob where Subjobtag='HeavyWeightvehicles'", con);
